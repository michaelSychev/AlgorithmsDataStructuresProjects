...
public interface TicTacToeBoard
{
    ...
    //THROW ASSERTION IF CALLED AFTER GAME ENDED
    //part of post: rv == null <==> it is neither player's turn (i.e.
    //   game is over)
    //part of post: “number of Marks on board is even”è rv == tictactoe.TicTacToeBoard.Mark.X
    //part of post: “number of Marks on board is odd” è rv == tictactoe.TicTacToeBoard.Mark.O
    public Mark getTurn();
