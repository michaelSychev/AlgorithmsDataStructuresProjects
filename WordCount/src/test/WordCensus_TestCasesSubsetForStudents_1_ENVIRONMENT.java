...
public class WordCensus_TestCasesSubsetForStudents_1_ENVIRONMENT
{
	...
	public static final String LAST_NAME = "Sychev";
	...
	public void lastNameTest()
	{
		...
		String actualClassName = getClassNameWithoutPackage(WordCensusImpl_Sychev.class);
	...
	protected Class<? extends WordCensus> getStudentClass()
	{
		...
		return WordCensusImpl_Sychev.class;
	}
