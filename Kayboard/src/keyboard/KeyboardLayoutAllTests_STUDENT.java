...
import keyboard.AppleNumericMB110LLKeyboardMetricsImpl_Sychev;
import keyboard.Key;
...
public class KeyboardLayoutAllTests_STUDENT 
{
	...
	{
		return new AppleNumericMB110LLKeyboardMetricsImpl_Sychev(keyLayout);
	}
	//HOME KEY STARTS WITH J IN QWERTY, DVROAK IS H,
	@Test
