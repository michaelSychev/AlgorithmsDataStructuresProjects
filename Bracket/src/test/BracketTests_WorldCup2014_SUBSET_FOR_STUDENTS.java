...
public class BracketTests_WorldCup2014_SUBSET_FOR_STUDENTS
{
	...
	public void setUp()
	{
		...
		worldCup2014KnockoutResults = new BracketImpl_Sychev<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups);
		...
		worldCup2014KnockoutResults_ALT = new BracketImpl_Sychev<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups_ALT);
		...
		worldCup2014KnockoutResults_NETHERLANDS_WINS_INSTEAD = new BracketImpl_Sychev<FIFASoccerTeam>(worldCup2014KnockoutRoundMatchups_ALT);
		worldCup2014KnockoutResults_NETHERLANDS_WINS_INSTEAD.setWinCount(NETHERLANDS, 4);
		worldCup2014KnockoutResults_NETHERLANDS_WINS_INSTEAD.setWinCount(GERMANY, 3);
		...
		worldCup_DEGENERATE = new BracketImpl_Sychev<FIFASoccerTeam>(matchups_DEGENERATE);
	}
